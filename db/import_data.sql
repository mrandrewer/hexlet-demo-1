...
(1, 1, 'База Строитель', 'Иванова', 'Александра', 'Ивановна', 'aleksandraivanova@ml.ru', '+7 493 123 45 67', '652050', 'Кемеровская область', 'город Юрга', 'ул. Лесная', '15', '2222455179', 7),
(2, 2, 'Паркет 29', 'Петров', 'Василий', 'Петрович', 'vppetrov@vl.ru', '+7 987 123 56 78', '164500', 'Архангельская область', 'город Северодвинск', 'ул. Строителей', '18', '3333888520', 7),
(3, 3, 'Стройсервис', 'Соловьев', 'Андрей', 'Николаевич', 'ansolovev@st.ru', '+7 812 223 32 00', '188910', 'Ленинградская область', 'город Приморск', 'ул. Парковая', '21', '4440391035', 7),
(4, 4, 'Ремонт и отделка', 'Воробьева', 'Екатерина', 'Валерьевна', 'ekaterina.vorobeva@ml.ru', '+7 444 222 33 11', '143960', 'Московская область', 'город Реутов', 'ул. Свободы', '51', '1111520857', 5),
(5, 1, 'МонтажПро', 'Степанов', 'Степан', 'Сергеевич', 'stepanov@stepan.ru', '+7 912 888 33 33', '309500', 'Белгородская область', 'город Старый Оскол', 'ул. Рабочая', '122', '5552431140', 0);
